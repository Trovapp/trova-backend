...
public record GeocodingResult(
        ...
        List<KakaoKeywordSearchResponse.Document> alternativeCandidates
) {
    ...
    public static GeocodingResult empty() {
        return new GeocodingResult(null, null, null, null, null, null, null, null, List.of());
    }
    ...
    public static GeocodingResult coordinatesOnly(Double latitude, Double longitude) {
        return new GeocodingResult(latitude, longitude, null, null, null, null, null, null, List.of());
    }
    ...
    public static GeocodingResult fromDocument(KakaoKeywordSearchResponse.Document doc) {
        return new GeocodingResult(
                Double.parseDouble(doc.y()), Double.parseDouble(doc.x()), doc.placeName(),
                doc.phone(), doc.addressName(), doc.roadAddressName(),
                doc.categoryName(), doc.placeUrl(), List.of());
    }
}
